...
func main() {
	...
	brokerURL := flag.String("broker-url", "localhost", "MQTT broker URL")
	...
	config := &coordinators.MessageCoordinatorConfig{
		BrokerURL:            *brokerURL,
		BrokerPort:           *brokerPort,
		MonitorInterval:      30 * time.Second,
		MaxReconnectAttempts: 10,
	}
	config.Name = "message-coordinator"
	...
	coordinator, err := coordinators.NewMessageCoordinator(config, logger)
	if err != nil {
